...
public class MainActivity extends AuthActivity {
	...
	private Long userId;
	private String nick;
	private TopAndroidClient client=TopAndroidClient.getAndroidClientByAppKey("21682376");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				//Uri uri = Uri.parse("https://oauth.taobao.com/authorize?response_type=token&view=wap&redirect_uri=http://www.nxgoods.com&client_id=21670038");  
...
//		  client.
//		  client.setTokenStore(new ConcurrentHashMap<Long, AccessToken>(userId,))
//	 }
}
